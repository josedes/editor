...
ActiveRecord::Schema.define(version: 20150526221452) do
  ...
  add_index "menu_nivel0s", ["usuario_id"], name: "index_menu_nivel0s_on_usuario_id", using: :btree
  ...
  add_index "menu_nivel1s", ["MenuNivel0_id"], name: "index_menu_nivel1s_on_MenuNivel0_id", using: :btree
  add_index "menu_nivel1s", ["contenido_id"], name: "index_menu_nivel1s_on_contenido_id", using: :btree
  ...
  add_index "menu_nivel2s", ["contenido_id"], name: "index_menu_nivel2s_on_contenido_id", using: :btree
